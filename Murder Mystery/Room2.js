class DetectiveRoom2 {
  ...
  infobuttonRoom(infobuttonX, infobuttonY) {
    push();
    ...
    if (distance < 40 / 2) {
      ...
      fill("black");
      text(
        "You have uncovered a cryptic code embedded in the \ncrime scene photo. Your sharp instincts lead you to \ndecipher the encrypted language. Amidst the intricate \nsymbols, a translated sentence emerges, shedding light \non the obscured truth. This vital clue propels you \nforward, unraveling the threads of the enigma.",
        72,
        120
      );
      fill("white");
  ...
  hint(hintX, hintY) {
    ...
    if (this.hintBox == true) {
      ...
      fill("black");
      text("Go back 5 letters for each letter in \nthe paper", -195, 35);
    }
    pop();
  }
  ...
  draw() {
    ...
    if (keyIsDown(RIGHT_ARROW)) {
      this.playerX += 3;
      if (!this.answer && this.playerX > 700) {
        this.playerX = 690;
      }
    }
